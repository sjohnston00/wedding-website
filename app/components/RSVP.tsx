      ...
      <div id="food-options" ref={foodOptionsRef} hidden>
        ...
        <fieldset>
          ...
          <label className="block">
            <input type="radio" name="starter" id="starter" value="starter-1" />
            Starter 1
          </label>
          <label className="block">
            <input type="radio" name="starter" id="starter" value="starter-2" />
            Starter 2
          </label>
        </fieldset>
        ...
        <fieldset>
          <h3>Dessert</h3>
          <label className="block">
            <input type="radio" name="dessert" id="dessert" value="dessert-1" />
            dessert 1
          </label>
          <label className="block">
            <input type="radio" name="dessert" id="dessert" value="dessert-2" />
            dessert 2
          </label>
        </fieldset>
      </div>
